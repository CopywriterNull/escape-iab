    ...
    <header className="sticky top-0 z-40 backdrop-blur-md bg-[var(--color-bg)]/70 border-b border-[var(--color-border)]">
      <div className="mx-auto max-w-6xl px-5 h-14 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-7 text-sm text-[var(--color-fg-dim)]">
          ...
          <a href="#features" className="hover:text-[var(--color-fg)]">Features</a>
        ...
        <div className="flex items-center gap-2">
          ...
          <a href="#waitlist" className="text-sm text-[var(--color-fg-dim)] hover:text-[var(--color-fg)] px-3 py-1.5">
            Sign in
          </a>
          <a
            href="#waitlist"
...
function Waitlist() {
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[var(--color-cta-bg)] text-[var(--color-cta-fg)] font-medium hover:opacity-90 shadow-[0_8px_30px_rgba(91,140,255,0.25)]"
      >
        Get early access
        <ArrowRight />
      </button>
  ...
  return (
    <section id="faq" className="mx-auto max-w-3xl px-5 py-24 border-t border-[var(--color-border)]">
      ...
      <div className="mt-12 rounded-2xl border border-[var(--color-border)] bg-[var(--color-card)] p-8 text-center">
        ...
        <a href="#waitlist" className="inline-block mt-5 px-5 py-3 rounded-xl bg-[var(--color-cta-bg)] text-[var(--color-cta-fg)] font-medium hover:opacity-90">
          Get early access
        </a>
      </div>
    </section>
