...
// Render at request time so production can access runtime Supabase env vars.
// The analytics bundle below is cached for 5 min to keep the landing page fast.
...
export default async function Home() {
  const proof = await loadHomepageProof();
...
const loadHomepageProof = unstable_cache(
  async (): Promise<HomepageProof> => {
    ...
    return { liftPct, rpvLiftPct, escapesToday, caseStudy, calculator };
  },
  ["homepage-proof-v2"],
  { revalidate: 300, tags: ["homepage-proof"] },
);
