      ...
      <header className="md:hidden sticky top-0 z-30 border-b border-[var(--color-border-soft)] bg-[var(--color-bg)]/95 backdrop-blur">
        <div className="px-4 h-12 flex items-center justify-between gap-3">
          ...
          <nav className="flex items-center gap-1 text-[12px]">
            ...
            <Link href="/admin/billing" className="px-2 py-1 text-[var(--color-fg-muted)]">Billing</Link>
            <Link href="/admin/referrers" className="px-2 py-1 text-[var(--color-fg-muted)]">Referrals</Link>
            <Link href="/admin/links" className="px-2 py-1 text-[var(--color-fg-muted)]">Links</Link>
